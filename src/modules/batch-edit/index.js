...
module.exports = {
  bulkActions: ({ endpoint, payloads }) => {
    if (!endpoint) throw new Error('Endpoint object should be specified');

    if (!endpoint.url) throw new Error('Endpoint path should be specified');

    if (!endpoint.verb) throw new Error('Endpoint verb should be specified');
